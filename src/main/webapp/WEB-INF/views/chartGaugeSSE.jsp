...
$(function () {
	...
	function polling() {
		$.get("<c:url value="/chartDataSSEPublish.do"/>", function(data, status){
	...
	if (!!window.EventSource) {
		   var source = new EventSource('<c:url value="/chartDataSSEOpen.do"/>');
...
<body>
<h2>Server Push : Sever Sent Events</h2>
